...
export function NoteCard({ note, onNoteDeleted }: NoteCard) {
  ...
  return (
    <>
      <Dialog.Root>
        <Dialog.Trigger
          className='rounded-md text-left flex flex-col bg-slate-800 p-5 gap-3 relative outline-none overflow-hidden 
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className='z-10 inset-0 md:inset-auto fixed md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none overflow-hidden'>
